...
public class Event extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2703336691824636588L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Event\",\"namespace\":\"schemas.event.v6\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"number\",\"type\":\"long\",\"default\":0}]}");
   ...
   */
  public Event(java.lang.CharSequence id, java.lang.Long number) {
    this.id = id;
    this.number = number;
  }
   ...
   */
  public static schemas.event.v6.Event.Builder newBuilder() {
    return new schemas.event.v6.Event.Builder();
  }
   ...
   * @return A new Event RecordBuilder
   */
  public static schemas.event.v6.Event.Builder newBuilder(schemas.event.v6.Event.Builder other) {
    if (other == null) {
      return new schemas.event.v6.Event.Builder();
    } else {
      return new schemas.event.v6.Event.Builder(other);
    }
  }
   ...
   * @return A new Event RecordBuilder
   */
  public static schemas.event.v6.Event.Builder newBuilder(schemas.event.v6.Event other) {
    if (other == null) {
      return new schemas.event.v6.Event.Builder();
    } else {
      return new schemas.event.v6.Event.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Event>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(schemas.event.v6.Event.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(schemas.event.v6.Event other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public schemas.event.v6.Event.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public schemas.event.v6.Event.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public schemas.event.v6.Event.Builder setNumber(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public schemas.event.v6.Event.Builder clearNumber() {
