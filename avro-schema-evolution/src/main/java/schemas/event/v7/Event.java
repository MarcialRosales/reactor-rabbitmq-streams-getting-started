...
public class Event extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6039026057619679216L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Event\",\"namespace\":\"schemas.event.v7\",\"fields\":[{\"name\":\"number\",\"type\":\"long\"}]}");
   ...
   */
  public Event(java.lang.Long number) {
    this.number = number;
  }
   ...
   */
  public static schemas.event.v7.Event.Builder newBuilder() {
    return new schemas.event.v7.Event.Builder();
  }
   ...
   * @return A new Event RecordBuilder
   */
  public static schemas.event.v7.Event.Builder newBuilder(schemas.event.v7.Event.Builder other) {
    if (other == null) {
      return new schemas.event.v7.Event.Builder();
    } else {
      return new schemas.event.v7.Event.Builder(other);
    }
  }
   ...
   * @return A new Event RecordBuilder
   */
  public static schemas.event.v7.Event.Builder newBuilder(schemas.event.v7.Event other) {
    if (other == null) {
      return new schemas.event.v7.Event.Builder();
    } else {
      return new schemas.event.v7.Event.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Event>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(schemas.event.v7.Event.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(schemas.event.v7.Event other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.number)) {
        this.number = data().deepCopy(fields()[0].schema(), other.number);
    ...
    /**
      ...
      * @return This builder.
      */
    public schemas.event.v7.Event.Builder setNumber(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public schemas.event.v7.Event.Builder clearNumber() {
